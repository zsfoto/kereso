...
class CompaniesController extends AppController
{
    ...
    public function index($clearFilter = null)
    {
		...
		if($search !== ''){
			...
			$query = $this->Companies->find()->contain(['Icons', 'Categories'])->where($conditions);
		}
		// ############################# /.QUERY ###########################################
    ...
    public function view($id = null)
    {
		...
		try {
			$company = $this->Companies->get((int) $id, contain: ['Icons', 'Categories', 'Persons']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
			...
			*/
            ...
            //$this->Flash->error(__('The company could not be saved. Please, try again.'), ['plugin' => 'JeffAdmin5']);
        ...
        $this->set(compact('company', 'icons', 'categories'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $categories = $this->Companies->Categories->find('list', conditions: ['visible' => true], limit: 200, order: ['pos' => 'asc', 'name' => 'asc'])->all();
		$name = $company->name;
        $this->set(compact('company', 'icons', 'categories', 'id', 'name'));
    }
