...
<?php } ?>
											...
											<th class="string name-en"><?= $this->Paginator->sort('name_en') ?></th><!-- H.1. -->
											<th class="string name-de"><?= $this->Paginator->sort('name_de') ?></th><!-- H.1. -->
											<th class="string shortcode"><?= $this->Paginator->sort('shortcode') ?></th><!-- H.1. -->
											<th class="string currency"><?= $this->Paginator->sort('currency') ?></th><!-- H.1. -->
...
<?php } ?>
											...
											<td class="string name-en" value="<?= $country->name_en ?>"><?= h($country->name_en) ?></td>
											<td class="string name-de" value="<?= $country->name_de ?>"><?= h($country->name_de) ?></td>
											<td class="string shortcode" value="<?= $country->shortcode ?>"><?= h($country->shortcode) ?></td>
											<td class="string currency" value="<?= $country->currency ?>"><?= h($country->currency) ?></td>
<?php if($config['show_pos']){ ?>
...
<?php } ?>
<?php if($config['show_counters']){ ?>
											<td class="number counter city-count" value="<?= $country->city_count ?>"><?= h($country->city_count) ?></td><?php } ?>
<?php if($config['show_created'] || $config['show_modified']){ ?>
											<td class="datetime">
