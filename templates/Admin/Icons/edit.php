...
$this->assign('title', __('Edit') . ' ' . __('Icon'));
?>
				<div id="form-row" class="icons row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Icon') ?></h3>
...
<?php $this->Html->scriptStart(['block' => 'javaScriptBottom']); ?>
	...
	//jeffAdminInitDateTimePicker('last-used'<?= $icon->last_used !== null ? ", '" . $icon->last_used->format('Y-m-d H:i:s') . "'" : "" ?>)
