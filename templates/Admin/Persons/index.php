...
<?php } ?>
											...
											<th class="string keywoords-slug"><?= $this->Paginator->sort('keywoords_slug') ?></th><!-- H.1. -->
...
<?php } ?>
											...
											<td class="string keywoords-slug" value="<?= $person->keywoords_slug ?>"><?= h($person->keywoords_slug) ?></td>
